...
public class NoticeAdapter extends RecyclerView.Adapter<NoticeAdapter.EmployeeViewHolder> {
    ...
    public NoticeAdapter(List<Employee> dataList , RecyclerItemClickListener recyclerItemClickListener) {
    ...
    public void onBindViewHolder(EmployeeViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        holder.txtNoticeTitle.setText(dataList.get(position).getEmployee_name());
        holder.txtNoticeBrief.setText(dataList.get(position).getEmployee_age());
        holder.txtNoticeFilePath.setText(dataList.get(position).getEmployee_salary());
